 ...
 */
final class Version20230525115211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ride CHANGE departure depart VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ride CHANGE depart departure VARCHAR(255) NOT NULL');
    }
}
